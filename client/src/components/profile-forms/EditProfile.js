...
import { createOrEditProfile, getMyProfile } from '../../actions/profile';
      ...
      <form className="form" onSubmit={e => onSubmit(e)}>
        ...
        <div className="my-2">
          <button
            ...
            onClick={() => toggleStatusDisplaySocial(!statusDisplay)}
          >
...
export default connect(mapStateToProps, { createOrEditProfile, getMyProfile })(
  EditProfile,
);
